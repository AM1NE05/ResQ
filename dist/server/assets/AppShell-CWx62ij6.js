import { M as useRouter, r as reactExports, U as jsxRuntimeExports, a0 as React, T as React$1 } from "./worker-entry-BCiOq1yH.js";
import { r as reactDomExports, R as ReactDOM, _ as __assign, b as __rest, c as __spreadArray, a as useI18n, u as useAuth, s as supabase, t as toast, L as Link } from "./router-Bo5vnDPi.js";
...
function Logo({ className = "h-10 w-10" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoImg, alt: "ResQ Najda", className: `${className} object-contain` });
}
function LogoLockup({ className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-2 ${className}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-extrabold tracking-tight text-navy-foreground", children: [
      "ResQ ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-emergency", children: "نجدة" })
    ] })
  ] });
}
...
function LanguageSwitcher({ variant = "light" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuContent, { align: "end", children: LANGS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuItem, { onClick: () => setLang(l.code), className: lang === l.code ? "font-bold" : "", children: l.label }, l.code)) })
  ] });
}
function NotificationsBell() {
    ...
    const channel = supabase.channel(`notif:${user.id}`).on(
      ...
      (payload) => {
        ...
        toast.success(t(`notif.${n.title}.title`), {
          ...
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Siren, { className: "h-4 w-4" })
        });
      }
    ).subscribe();
    return () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          ...
          unread > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-0.5 -right-0.5 flex h-4 min-w-4 items-center justify-center rounded-full bg-emergency px-1 text-[10px] font-bold text-emergency-foreground", children: unread })
        ]
      }
    ),
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute end-0 mt-2 z-50 w-80 max-w-[90vw] rounded-2xl bg-card text-card-foreground shadow-[var(--shadow-elevated)] overflow-hidden", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border px-4 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold", children: t("notif.title") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CheckCheck, { className: "h-4 w-4 text-muted-foreground" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-h-96 overflow-y-auto", children: [
          items.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-8 text-center text-sm text-muted-foreground", children: t("notif.empty") }),
          items.map((n) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex gap-3 border-b border-border px-4 py-3 ${!n.read ? "bg-emergency/5" : ""}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Siren, { className: "mt-0.5 h-5 w-5 flex-shrink-0 text-emergency" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: t(`notif.${n.title}.title`) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 text-xs text-muted-foreground", children: t(`notif.${n.title}.body`) }),
...
function AppHeader() {
  const { user } = useAuth();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-navy-gradient", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-md items-center justify-between px-4 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(LogoLockup, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageSwitcher, { variant: "dark" }),
      user && /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationsBell, {})
    ] })
  ] }) });
}
function useIsAdmin() {
...
function BottomNav() {
  ...
  const left = [
    ...
    { to: "/map", icon: Map$1, label: t("nav.map") }
  ];
  const right = [
    { to: "/profile", icon: User, label: t("nav.profile") },
    { to: "/help", icon: CircleQuestionMark, label: t("nav.help") },
    ...isAdmin ? [{ to: "/admin", icon: ShieldCheck, label: t("nav.admin") }] : []
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed inset-x-0 bottom-0 z-40 border-t border-border bg-card/95 backdrop-blur-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "mx-auto flex max-w-md items-end justify-around px-4 pb-3 pt-2", children: [
    left.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { item, active: loc.pathname === item.to }, item.to)),
    /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "-mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Link,
      {
        to: "/",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Siren, { className: "h-7 w-7" })
      }
    ) }),
    right.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(NavItem, { item, active: loc.pathname === item.to }, item.to))
  ] }) });
}
function NavItem({
  item,
...
function AuthScreen() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col bg-hero text-navy-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(LogoLockup, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LanguageSwitcher, { variant: "dark" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 flex-col items-center justify-center px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-extrabold leading-tight", children: t("auth.welcome") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-white/70", children: t("auth.sub") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: submit, className: "space-y-3 rounded-3xl bg-card/95 p-6 text-foreground shadow-[var(--shadow-elevated)] backdrop-blur-xl", children: [
        mode === "signup" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1 block text-sm font-medium", children: t("auth.fullName") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1 block text-sm font-medium", children: t("auth.email") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "email",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1 block text-sm font-medium", children: t("auth.password") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "password",
...
function AppShell({ children }) {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-hero", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { className: "h-16 w-16 animate-pulse" }) });
  }
  if (!user) return /* @__PURE__ */ jsxRuntimeExports.jsx(AuthScreen, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AppHeader, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "mx-auto max-w-md px-4 pb-28 pt-4", children }),
