  ...
  head: () => ({
    meta: [
      { title: "ResQ Najda — Help & info" },
      {
        name: "description",
        content:
          "How to use ResQ Najda, our partners, rules, and emergency numbers.",
      },
    ],
  }),
  component: () => (
    ...
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border-2 border-emergency/40 bg-emergency/5 p-5 shadow-[var(--shadow-card)]">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-base font-bold text-emergency">
            {t("help.danger")}
          </h2>
        </div>
      ...
      <Section
        ...
        tone="bg-warning/30 text-foreground"
      >
